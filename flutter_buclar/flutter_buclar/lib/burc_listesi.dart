...
import 'package:flutter_buclar/burc_item.dart';
import 'package:flutter_buclar/data/strings.dart';
import 'package:flutter_buclar/model/burc.dart';

class BurcListesi extends StatelessWidget {
  late List<Burc> tumBurclar;
  BurcListesi() {
    tumBurclar = veriKynaginiHazirla();
  }
